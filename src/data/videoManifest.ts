...
const videoManifest: Record<string, AnimalVideoEntry> = {
  ...
  'tortoise-idle':    { url: `${BASE_URL}/turtle_idle.mp4`,    poster: '', description: 'Shelly the Tortoise resting calmly' },
  'tortoise-receive': { url: `${BASE_URL}/turtle_receive.mp4`, poster: '', description: 'Shelly reads your letter and writes back' },
